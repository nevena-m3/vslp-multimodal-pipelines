...
VIDEO_QC_FRAMEWORK_PLACEHOLDER = [
    {
        "degradation_family": "Lighting / exposure",
        "status": "placeholder_to_be_built_in",
        "examples": "poor lighting, backlighting, overexposure, underexposure, glare",
        "future_checks": "brightness/contrast statistics, face-region exposure, reviewer flag",
        "current_automated_support": "not implemented",
    },
    {
        "degradation_family": "Frame freezing / dropped frames",
        "status": "placeholder_to_be_built_in",
        "examples": "frozen frames, repeated frames, dropped frame bursts, stuttered video",
        "future_checks": "frame-difference entropy, duplicate-frame runs, timestamp discontinuity",
        "current_automated_support": "not implemented",
    },
    {
        "degradation_family": "Camera instability / motion",
        "status": "placeholder_to_be_built_in",
        "examples": "handheld shake, camera bumps, sudden zoom, unstable tripod",
        "future_checks": "global optical-flow magnitude, background motion, frame-to-frame transform",
        "current_automated_support": "not implemented",
    },
    {
        "degradation_family": "Multiple people / face confusion",
        "status": "placeholder_to_be_built_in",
        "examples": "another person enters frame, face switch, caregiver face visible",
        "future_checks": "multi-face count, identity consistency, reviewer adjudication",
        "current_automated_support": "not implemented",
    },
    {
        "degradation_family": "Occlusion / cropping",
        "status": "placeholder_to_be_built_in",
        "examples": "hand over mouth, mask, microphone blocking lips, face partly out of frame",
        "future_checks": "mouth/eye landmark availability, face bounding margin, occlusion flags",
        "current_automated_support": "partially approximated by face/landmark missingness",
    },
    {
        "degradation_family": "Pose / face angle",
        "status": "placeholder_to_be_built_in",
        "examples": "large yaw/pitch/roll, looking away, inconsistent head pose",
        "future_checks": "head-pose proxy, eye-anchor distortion, face-box geometry, reviewer status",
        "current_automated_support": "partially approximated by normalization/anchor instability",
    },
    {
        "degradation_family": "Focus / resolution",
        "status": "placeholder_to_be_built_in",
        "examples": "blurred video, low resolution, compression artifacts, pixelated mouth",
        "future_checks": "sharpness/blur score, resolution thresholds, compression artifact proxy",
        "current_automated_support": "not implemented",
    },
    {
        "degradation_family": "Task compliance / usable behavior",
        "status": "placeholder_to_be_built_in",
        "examples": "wrong task, no speech/movement, off-camera movement, interrupted trial",
        "future_checks": "task-specific movement presence, manual review notes, compliance label",
        "current_automated_support": "not implemented",
    },
]
...
def write_video_qc_framework_placeholder(output_root: Path | str) -> dict[str, Path]:
    ...
    payload = {
        ...
        "framework_placeholder_scope": "Empty degradation-family scaffold only. Detailed checks, thresholds, plots, and reviewer workflow are intentionally not implemented yet.",
        "not_yet_implemented": [
            "lighting/exposure QC",
            "frame-freeze and dropped-frame QC",
            "camera instability QC",
            "multi-person/face-switch QC",
            "occlusion/cropping QC",
            "pose-angle QC",
            "focus/resolution QC",
            "task-compliance QC",
        ...
        "degradation_families": VIDEO_QC_FRAMEWORK_PLACEHOLDER,
    }
