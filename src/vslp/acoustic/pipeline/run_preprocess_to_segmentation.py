...
from vslp.core.project import ACOUSTIC_ONLY_DIRS, initialize_project
...
def run_acoustic_ingest_preprocess_segment(
    ...
    initialize_project(output_root=output_root, project_name=project_name, layout=ACOUSTIC_ONLY_DIRS)
