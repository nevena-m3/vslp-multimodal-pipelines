...
def build_feature_computation_policy(feature_registry: pd.DataFrame | None = None) -> pd.DataFrame:
    ...
    family_policy = {
        ...
        "Articulatory / formant": {
            ...
            "file_level_reduction": "mean formants, median bandwidths, max-min ranges, and protocol-sign slope medians/5th/95th percentiles",
...
def build_feature_family_policy_summary() -> pd.DataFrame:
    ...
    rows = [
        ...
        },
        {
            ...
            "default_region": "valid speech frames",
            "scalar_reduction": "mean formants, median bandwidths, max-min ranges, slope percentiles",
